	...
	return async dispatch => {
		try {
			...
			const res = await axios.get(
				`https://ecommerceherni.herokuapp.com/admin/brandswithpagination?page=${page}`
			);
...
export function getOrderDetails(id) {
	return async dispatch => {
		try {
			dispatch(fetchPending());
			const res = await axios.get(
				`https://ecommerceherni.herokuapp.com/admin/dataaboutorder/${id}`
			);
...
export function createdProduct(elem, aux) {
	return async () => {
		try {
			await axios.post('https://ecommerceherni.herokuapp.com/admin/addproduct', [elem, aux]);
		} catch (error) {
			console.log(error);
		}
	};
...
// 	return async dispatch => {
// 		try {
// 			const res = axios.post('https://ecommerceherni.herokuapp.com/shoppingcart/userCart/update', {userId, cart});
// 		} catch (error) {
// 			console.log(error.response);
// 		}
// 	};
...
export const postUserFavorites = (userId, favorites) => {
	return async dispatch => {
		try {
			const res = await axios.post(`https://ecommerceherni.herokuapp.com/favorites`, {
				userId: userId,
				prodId: favorites
			});
			dispatch({
...
export const getUserFavorites = userId => {
	return async dispatch => {
		try {
			const res = await axios.get(
				`https://ecommerceherni.herokuapp.com/favorites/user/${userId}`
			);
			dispatch({
...
export function getRates() {
	return async dispatch => {
		try {
			const res = await axios.get('https://ecommerceherni.herokuapp.com/coinpayment/rate');
			dispatch({
				type: GET_RATES,
				payload: res.data
			});
